...
<head>
  ...
  <style>
    /* FUENTES CRÍTICAS */
    @font-face { font-family: "BankGothic Medium"; src: url("/assets/fonts/bankGothic/bank gothic medium bt.ttf") format("truetype"); font-weight: 600; font-display: swap; }
    @font-face { font-family: "AlternateGothic"; src: url("/assets/fonts/alternategothic/7047-fontps.ttf") format("truetype"); font-weight: normal; font-display: swap; }

    /* LAYOUT BASE Y RESET */
    html, body { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: "BankGothic Medium", Arial, sans-serif; background: url("/assets/img/body-back.webp") repeat fixed; background-color: #1a1a1a; }
    main { margin-top: 6em; }

    /* HEADER Y NAVEGACIÓN */
    header { background-image: url("/assets/img/bg_menu.webp"); display: flex; border-bottom: 7px solid #ff5f01; position: fixed; top: 0; left: 0; width: 100%; z-index: 10; }
    header nav { color: white; margin: 0 auto; display: flex; font-size: 18px; align-items: center; gap: 20px; }
    header nav img { height: 64px; width: 216px; margin-right: 2em; }
    header nav ul { display: flex; gap: 2em; list-style: none; }
    header nav ul li a { color: white; text-decoration: none; position: relative; }
    .reservas { background-color: #ff5f01; padding: 40px 5px 10px 5px; margin-bottom: 40px; }

    /* RESPONSIVE MÓVIL */
    .burger { width: 35px; display: none; flex-direction: column; cursor: pointer; z-index: 300; }
    .burger .bar { height: 2px; width: 100%; background: white; margin: 5px 0; }
    @media (max-width: 550px) {
      header nav ul { display: none; }
      .burger { display: flex; }
      header nav img { width: 150px; height: auto; margin-right: 0.5em; }
      main { margin-top: 4em; }
    }

    /* HERO SECTION */
    .main-container { min-height: 80vh; position: relative; background-image: url("/assets/img/home.webp"); background-size: cover; background-position: center; }
    .reservas-container { position: absolute; bottom: 10px; left: 50%; transform: translateX(-50%); text-align: center; width: 100%; }
    .reservas-container a { font-size: clamp(20px, 5vw, 35px); color: white; background-color: #ff5f01; padding: 10px 20px; text-decoration: none; font-weight: bold; }
    .reservas-container p:first-of-type { color: #ff5f01; font-size: clamp(24px, 6vw, 32px); text-transform: uppercase; }
  </style>
